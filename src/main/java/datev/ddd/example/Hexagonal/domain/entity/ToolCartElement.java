...
@Aggregate
@Getter
public class ToolCartElement implements CartElement {
    ...
    public ToolCartElement(String name, Quantity maxQuantity, Money singleUnitPrice) {
        this.name = name;
    ...
    public Money getCalculatedPrice() {
        return this.singleUnitPrice.times(this.quantity);
    }
}
